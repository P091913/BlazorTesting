...
namespace TestingBlazor
{
    public class UnitTest2 : TestContext
    {
        ...
        public void AddFossil()
        {
            ...
            Assert.Contains(68, component.Instance.fossils.Select(f => f.Age));
        ...
        public void ClearInputAfterAddingFossil()
        {
            ...
            Assert.Equal(string.Empty, component.Find("#age").GetAttribute("value"));
